...
export const Hyperspeed: React.FC<HyperspeedProps> = ({ effectOptions = {}, className = '', style = {} }) => {
  ...
  useEffect(() => {
    ...
    function resizeRendererToDisplaySize(renderer: THREE.WebGLRenderer, setSize: (w: number, h: number) => void) {
  ...
  return <div id="lights" ref={hyperspeed} className={className} style={style} />;
};
